...
const eventData = [
  ...
  },
  {
    ...
    image: assets.StartupAttiEvent3,
  ...
  },
  {
    ...
    organizerLink:
      "https://www.linkedin.com/company/dna-community/posts/?feedView=all",
  },
  {
  ...
  {
    name: "Playout",
    image: assets.playOut,
    link: "https://www.linkedin.com/feed/update/urn:li:activity:7236072710877945857/",
    desc: "Had an amazing time at PlayOut – Edition 3 by Teedians Community, where networking happened through football, fun, and genuine conversations.Grateful for the meaningful connections and the refreshing experience beyond the usual professional setting.",
    organizedBy: assets.thinkDigital,
    organizerLink: "https://think-digital.in/",
  },
  {
    name: "Movie Screening - Feb 2025",
    image: assets.movieScreeningFeb25,
    link: "https://www.linkedin.com/feed/update/urn:li:activity:7297171828706353152/",
    desc: "Watching Interstellar with the Teedians Community gave me fresh insights into the film and life itself through deep conversations and shared experiences. Networking once again proved powerful, connecting ideas, people, and perspectives in unexpected ways.",
    organizedBy: assets.thinkDigital,
    organizerLink: "https://think-digital.in/",
  },
  {
    name: "Startup Atti - Mar 2025",
    image: assets.StartupAttiEvent2,
    link: "https://www.linkedin.com/feed/update/urn:li:activity:7309470273043320833/",
    desc: "I attended the StartupAtti SaaS hangout where insightful speakers shared valuable advice on building connections, courage, and continuous learning. The event’s team-building approach and community spirit made it a memorable experience, inspiring me to keep building and growing.",
    organizedBy: assets.StartupAttiLogo,
    organizerLink: "https://www.linkedin.com/showcase/startupatti/posts/?feedView=all",
  },
  {
    name: "Your Inner compass - Inea Workshop",
    image: assets.movieScreeningFeb25,
    link: "https://www.linkedin.com/feed/update/urn:li:activity:7297171828706353152/",
    desc: "Watching Interstellar with the Teedians Community gave me fresh insights into the film and life itself through deep conversations and shared experiences. Networking once again proved powerful, connecting ideas, people, and perspectives in unexpected ways.",
    organizedBy: assets.thinkDigital,
